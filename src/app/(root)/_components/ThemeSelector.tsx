  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-accent-blue/5 to-accent-purple/5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity" />

        <Palette className="w-4 h-4 text-text-secondary group-hover:text-text-primary transition-colors" />

        <span className="text-text-secondary min-w-[80px] text-left group-hover:text-text-primary transition-colors">
          {currentTheme?.label}
        </span>
        ...
        <div
          className="relative w-4 h-4 rounded-full border border-text-secondary/50 group-hover:border-text-secondary transition-colors"
        ...
        {isOpen && (
          ...
          >
            <div className="px-2 pb-2 mb-2 border-b border-primary-background/50">
              <p className="text-xs font-medium text-text-secondary px-2">Select Theme</p>
            </div>
            ...
            {THEMES.map((t, index) => (
              <motion.button
                ...
                className={`
                relative group w-full flex items-center gap-3 px-3 py-2.5 hover:bg-primary-background transition-all duration-200
                ${theme === t.id ? "bg-accent-blue/10 text-accent-blue" : "text-text-secondary"}
              `}
              ...
              group-hover:opacity-100 transition-opacity"
                ...
                ${theme === t.id ? "bg-accent-blue/10 text-accent-blue" : "bg-primary-background text-text-secondary"}
